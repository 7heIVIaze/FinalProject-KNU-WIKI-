...
const passport = require('./middleware/userPassport')
...
const canAnybodyWriteMiddleware = require('./middleware/canAnybodyWrite')
const validationMiddleware = require('./middleware/validationMiddleware')
const canAnybodyRevertMiddleware = require('./middleware/canAnybodyRevert')
const ALCvalidationMiddleware = require('./middleware/ACLvalidation')
...
app.get('/edit/:id', canAnybodyWriteMiddleware, createController)
app.get('/w', validationMiddleware, searchDocumentController)
app.get('/w/:id', getDocumentController)
app.get('/history/:id', historyController)
app.get('/revert/:id', canAnybodyRevertMiddleware, revertController)
...
app.get('/acl/:id', ALCvalidationMiddleware, aclController)
